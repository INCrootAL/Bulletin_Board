...
<div class="_lk-panel">
    <div class="lk-panel-info-left">
        ...
        <div class="lk-panel-info-menu">
            ...
            <a class="lk-panel-info-menu-items"href="/personal/profile/vac/"<?if($APPLICATION->GetCurPage() == '/personal/profile/vac/'){?> style="color:#035AA6;border-radius: 10px;border: 1px solid #035AA6;"<?}?>>Вакансии</a>
            <a class="lk-panel-info-menu-items"href="/personal/profile/wishlist/"<?if($APPLICATION->GetCurPage() == '/personal/profile/'){?> style="color:#035AA6;border-radius: 10px;border: 1px solid #035AA6;"<?}?>>Избранное</a>
            <a class="lk-panel-info-menu-items"href="/personal/profile/settings/"<?if($APPLICATION->GetCurPage() == '/personal/profile/'){?> style="color:#035AA6;border-radius: 10px;border: 1px solid #035AA6;"<?}?>>Настройки аккаунта</a>
        </div>
    </div>
    <div class="lk-panel-info-right">
        <div class="lk-panel-info-right-title">
            ...
            <span class="lk-panel-info-right-title-t">Вакансии</span>
        </div>
        <div class="lk-panel-info-right-about-us">
            <?$APPLICATION->IncludeComponent(
                	"bitrix:catalog.section", 
                	"new-castom-section-martimer-lk-comp", 
                	array(
