										...
										<div class="mb-3">
											...
											if (!empty($mainBlockProperties))
											{
												...
												<ul class="product-item-detail-properties">
												    <div class="product-item-detail-properties-top">
                                                		<div class="page-left-top-up-det" style="margin-top: -130px">    
													...
													{?>	
														<?if ($property['ID'] == 66 || $property['ID'] == 69 || $property['ID'] == 70 || $property['ID'] == 71 || $property['ID'] == 72 || $property['ID'] == 73 || $property['ID'] == 74 || $property['ID'] == 75 || $property['ID'] == 76 || $property['ID'] == 77 || $property['ID'] == 78 || $property['ID'] == 79 || $property['ID'] == 80 || $property['ID'] == 81 || $property['ID'] == 82 || $property['ID'] == 83 || $property['ID'] == 84 || $property['ID'] == 85 || $property['ID'] == 86 || $property['ID'] == 87 || $property['ID'] == 88 || $property['ID'] == 89 || $property['ID'] == 90 || $property['ID'] == 91 || $property['ID'] == 92 || $property['ID'] == 93 || $property['ID'] == 94 || $property['ID'] == 95 || $property['ID'] == 96 || $property['ID'] == 97 || $property['ID'] == 98 || $property['ID'] == 99 || $property['ID'] == 100 || $property['ID'] == 101) {?>
														<?}else if ($property['ID'] == 63){?>
														    <li class="product-item-detail-properties-item" id="product-item-detail-properties-item_<?=$property['ID']?>">
															<span class="product-item-detail-properties-name text-muted">ФИО</span>
													...
													?>
                                                    <div class="date-publick" id="date-publick">Размещено <span class="date-publick-val"><? echo strtolower(FormatDate("d F Y", MakeTimeStamp($arResult["DATE_ACTIVE_FROM"])))?></span></div>
													</div>
													
													<div class="product-item-detail-properties-bottom-overview">
													    <span class="title-info-element">Описание резюме</span>
													<?php
													foreach ($mainBlockProperties as $property)
													{?>
														<?if ($property['ID'] == 63 || $property['ID'] == 64 || $property['ID'] == 65 || $property['ID'] == 66 || $property['ID'] == 67 || $property['ID'] == 68 || $property['ID'] == 70 || $property['ID'] == 71 || $property['ID'] == 72 || $property['ID'] == 73 || $property['ID'] == 74 || $property['ID'] == 75 || $property['ID'] == 76 || $property['ID'] == 77 || $property['ID'] == 78 
														|| $property['ID'] == 79 || $property['ID'] == 80 || $property['ID'] == 81 || $property['ID'] == 82 || $property['ID'] == 83 || $property['ID'] == 84 || $property['ID'] == 85 || $property['ID'] == 86 || $property['ID'] == 87 || $property['ID'] == 88 || $property['ID'] == 89 || $property['ID'] == 90 || $property['ID'] == 91 || $property['ID'] == 92 || $property['ID'] == 93 || $property['ID'] == 94 || $property['ID'] == 95 || $property['ID'] == 96 || $property['ID'] == 97 || $property['ID'] == 98 || $property['ID'] == 99 || $property['ID'] == 100 || $property['ID'] == 101) { } else if ($property['ID'] == 21){?>
														    <li class="product-item-detail-properties-item" id="product-item-detail-properties-item_<?=$property['ID']?>">
															<span class="product-item-detail-properties-name text-muted"><?=$property['NAME']?></span>
															<!--<span class="product-item-detail-properties-dots"></span>-->
															<span class="product-item-detail-properties-value"><?=(is_array($property['DISPLAY_VALUE'])
        														...
        														<li class="product-item-detail-properties-item- title-contants">Контактная информация</li>
        												<?} else {?>
        												    <li class="product-item-detail-properties-item" id="product-item-detail-properties-item_<?=$property['ID']?>">
															<span class="product-item-detail-properties-name text-muted"><?=$property['NAME']?></span>
															<!--<span class="product-item-detail-properties-dots"></span>-->
													...
													<div class="product-item-detail-properties-bottom-dock">
													    <span class="title-info-element">Общие документы моряка</span>
													    <span class="line"></span>
													    <div class="product-item-detail-properties-bottom-dock-1">
    													<?php
    													foreach ($mainBlockProperties as $property)
    													{?>
    														<?if ($property['ID'] == 63 || $property['ID'] == 64 || $property['ID'] == 65 || $property['ID'] == 66 || $property['ID'] == 67 || $property['ID'] == 68 || $property['ID'] == 69 || $property['ID'] == 70 || $property['ID'] == 71 || $property['ID'] == 72 || $property['ID'] == 73 || $property['ID'] == 80 || $property['ID'] == 81 || $property['ID'] == 82 || $property['ID'] == 83 || $property['ID'] == 84 || $property['ID'] == 85 || $property['ID'] == 86 || $property['ID'] == 87 || $property['ID'] == 88 || $property['ID'] == 89 || $property['ID'] == 90 || $property['ID'] == 91 || $property['ID'] == 92 || $property['ID'] == 93 || $property['ID'] == 94 || $property['ID'] == 95 || $property['ID'] == 96 || $property['ID'] == 97 || $property['ID'] == 98 || $property['ID'] == 99 || $property['ID'] == 100 || $property['ID'] == 101) { } else if ($property['ID'] == 74){?>
    														    <li class="product-item-detail-properties-item" id="product-item-detail-properties-item_<?=$property['ID']?>">
    															<span class="product-item-detail-properties-name text-muted">Тип документа</span>
    															<!--<span class="product-item-detail-properties-dots"></span>-->
    															
    															<? if (is_array($property['DISPLAY_VALUE'])) {?>
        															    <?foreach ($property['DISPLAY_VALUE'] as $arrayPropert) {?>
            															    <span class="product-item-detail-properties-value"><?=$arrayPropert?></span>
        															    <?}?>
    															<?} else {?>
    															<span class="product-item-detail-properties-value"><?=(is_array($property['DISPLAY_VALUE'])
    																	? implode(' – ', $property['DISPLAY_VALUE'])
            												...
            												<?} else if ($property['ID'] == 77) {?>
            												    <li class="product-item-detail-properties-item" id="product-item-detail-properties-item_<?=$property['ID']?>">
    															<span class="product-item-detail-properties-name text-muted">Выдан</span>
    															<!--<span class="product-item-detail-properties-dots"></span>-->
    															<? if (is_array($property['DISPLAY_VALUE'])) {?>
    															    <?foreach ($property['DISPLAY_VALUE'] as $arrayPropert) {?>
        															    <span class="product-item-detail-properties-value"><?=$arrayPropert?></span>
													...
													<div class="product-item-detail-properties-bottom-dip">
													    <span class="title-info-element">Рабочий диплом</span>
													    <span class="line"></span>
													    <div class="product-item-detail-properties-bottom-dock-1">
													<?php
													foreach ($mainBlockProperties as $property)
													{?>
														<?if ($property['ID'] == 63 || $property['ID'] == 64 || $property['ID'] == 65 || $property['ID'] == 66 || $property['ID'] == 67 || $property['ID'] == 68 || $property['ID'] == 69 || $property['ID'] == 70 || $property['ID'] == 71 || $property['ID'] == 72 || $property['ID'] == 73 || $property['ID'] == 74 || $property['ID'] == 75 || $property['ID'] == 76 || $property['ID'] == 77 || $property['ID'] == 78 
														|| $property['ID'] == 79 || $property['ID'] == 85 || $property['ID'] == 86 || $property['ID'] == 87 || $property['ID'] == 88 || $property['ID'] == 89 || $property['ID'] == 90 || $property['ID'] == 91 || $property['ID'] == 92 || $property['ID'] == 93 || $property['ID'] == 94 || $property['ID'] == 95 || $property['ID'] == 96 || $property['ID'] == 97 || $property['ID'] == 98 || $property['ID'] == 99 || $property['ID'] == 100 || $property['ID'] == 101) { } else if ($property['ID'] == 80) {?>
														    <li class="product-item-detail-properties-item" id="product-item-detail-properties-item_<?=$property['ID']?>">
															<span class="product-item-detail-properties-name text-muted">Наименование документа</span>
															<!--<span class="product-item-detail-properties-dots"></span>-->
															<? if (is_array($property['DISPLAY_VALUE'])) {?>
    															    <?foreach ($property['DISPLAY_VALUE'] as $arrayPropert) {?>
        															    <span class="product-item-detail-properties-value"><?=$arrayPropert?></span>
        												...
        												<?} else {?>
															...
															<!--<span class="product-item-detail-properties-dots"></span>-->
    															<? if (is_array($property['DISPLAY_VALUE'])) {?>
        															...
        															<?} else {?>
        															<?if ($property['DISPLAY_VALUE'] != "01.01.0001") {?>
            															<span class="product-item-detail-properties-value"><?=(is_array($property['DISPLAY_VALUE'])
            																	? implode(' – ', $property['DISPLAY_VALUE'])
            																	: $property['DISPLAY_VALUE'])?>
                    													</span>
													...
													<div class="product-item-detail-properties-bottom-ser">
													    <span class="title-info-element">Сертификаты моряка</span>
													    <span class="line"></span>
													    <div class="product-item-detail-properties-bottom-dock-1">
													<?php
													foreach ($mainBlockProperties as $property)
													{?>
														<?if ($property['ID'] == 63 || $property['ID'] == 64 || $property['ID'] == 65 || $property['ID'] == 66 || $property['ID'] == 67 || $property['ID'] == 68 || $property['ID'] == 69 || $property['ID'] == 70 || $property['ID'] == 71 || $property['ID'] == 72 || $property['ID'] == 73 || $property['ID'] == 74 || $property['ID'] == 75 || $property['ID'] == 76 || $property['ID'] == 77 || $property['ID'] == 78 
														|| $property['ID'] == 79 || $property['ID'] == 80 || $property['ID'] == 81 || $property['ID'] == 82 || $property['ID'] == 83 || $property['ID'] == 84 || $property['ID'] == 90 || $property['ID'] == 91 || $property['ID'] == 92 || $property['ID'] == 93 || $property['ID'] == 94 || $property['ID'] == 95 || $property['ID'] == 96 || $property['ID'] == 97 || $property['ID'] == 98 || $property['ID'] == 99 || $property['ID'] == 100 || $property['ID'] == 101) { } else if ($property['ID'] == 85){?>
														    <li class="product-item-detail-properties-item" id="product-item-detail-properties-item_<?=$property['ID']?>">
															<span class="product-item-detail-properties-name text-muted">Наименование документа</span>
															<!--<span class="product-item-detail-properties-dots"></span>-->
															<? if (is_array($property['DISPLAY_VALUE'])) {?>
													...
													<div class="product-item-detail-properties-bottom-opt">
													    <span class="title-info-element">Опыт работы моряка</span>
													    <span class="line"></span>
													    <div class="product-item-detail-properties-bottom-dock-1">
													<?php
													foreach ($mainBlockProperties as $property)
													{?>
														<?if ($property['ID'] == 63 || $property['ID'] == 64 || $property['ID'] == 65 || $property['ID'] == 66 || $property['ID'] == 67 || $property['ID'] == 68 || $property['ID'] == 69 || $property['ID'] == 70 || $property['ID'] == 71 || $property['ID'] == 72 || $property['ID'] == 73 || $property['ID'] == 74 || $property['ID'] == 75 || $property['ID'] == 76 || $property['ID'] == 77 || $property['ID'] == 78 
														|| $property['ID'] == 79 || $property['ID'] == 80 || $property['ID'] == 81 || $property['ID'] == 82 || $property['ID'] == 83 || $property['ID'] == 84 || $property['ID'] == 85 || $property['ID'] == 86 || $property['ID'] == 87 || $property['ID'] == 88 || $property['ID'] == 89 || $property['ID'] == 90 ) { } else if ($property['ID'] == 91){?>
														    <li class="product-item-detail-properties-item" id="product-item-detail-properties-item_<?=$property['ID']?>">
															<span class="product-item-detail-properties-name text-muted">Должность</span>
															<!--<span class="product-item-detail-properties-dots"></span>-->
															<? if (is_array($property['DISPLAY_VALUE'])) {?>
    															    <?foreach ($property['DISPLAY_VALUE'] as $arrayPropert) {?>
        															    <span class="product-item-detail-properties-value"><?=$arrayPropert?></span>
													...
													<div class="product-item-detail-properties-bottom-cont">
													    <span class="title-info-element">Контактная информация</span>
													    <div class="product-item-detail-properties-bottom-cont-all">
													    <?foreach ($mainBlockProperties as $property)
        													{?>
															<?if ($property['ID'] == 63 || $property['ID'] == 64 || $property['ID'] == 65 || $property['ID'] == 66 || $property['ID'] == 67 || $property['ID'] == 68 || $property['ID'] == 69 || $property['ID'] == 74 || $property['ID'] == 75 || $property['ID'] == 76 || $property['ID'] == 77 || $property['ID'] == 78 || $property['ID'] == 79 || $property['ID'] == 80 || $property['ID'] == 81 || $property['ID'] == 82 || $property['ID'] == 83 || $property['ID'] == 84 || $property['ID'] == 85 || $property['ID'] == 86 || $property['ID'] == 87 || $property['ID'] == 88 || $property['ID'] == 89 || $property['ID'] == 90 || $property['ID'] == 91 || $property['ID'] == 92 || $property['ID'] == 93 || $property['ID'] == 94 || $property['ID'] == 95 || $property['ID'] == 96 || $property['ID'] == 97 || $property['ID'] == 98 || $property['ID'] == 99 || $property['ID'] == 100 || $property['ID'] == 101) { } else if ($property['ID'] == 70){?>
															       <div class = "product-item-detail-properties-item-1">
															           <?foreach ($mainBlockProperties as $propertyN) {
															           if ($propertyN['ID'] == 70 ) {?>
            														    <li class="product-item-detail-properties-item" id="product-item-detail-properties-item_<?=$propertyN['ID']?>">
                															<span class="product-item-detail-properties-name text-muted">Почта:</span>
                															<!--<span class="product-item-detail-properties-dots"></span>-->
                															<span class="product-item-detail-properties-value"><?=(is_array($propertyN['DISPLAY_VALUE'])
                																	? implode(' – ', $propertyN['DISPLAY_VALUE'])
                																	: $propertyN['DISPLAY_VALUE'])?>
                        													</span>
                    													</li>
                        												<?} else if ($propertyN['ID'] == 71) {?>
                        												<li class="product-item-detail-properties-item" id="product-item-detail-properties-item_<?=$propertyN['ID']?>">
                															<span class="product-item-detail-properties-name text-muted"><?=$propertyN['NAME']?>:</span>
                															<!--<span class="product-item-detail-properties-dots"></span>-->
                															<span class="product-item-detail-properties-value"><?=(is_array($propertyN['DISPLAY_VALUE'])
                																	? implode(' – ', $propertyN['DISPLAY_VALUE'])
                																	: $propertyN['DISPLAY_VALUE'])?>
        														...
        														<?php
        													    } else if ($property['ID'] == 72) {?>
        													    <div class = "product-item-detail-properties-item-2">
        													    <?foreach ($mainBlockProperties as $propertyN) {
															           if ($propertyN['ID'] == 72 || $propertyN['ID'] == 73) {?>
            														    <li class="product-item-detail-properties-item" id="product-item-detail-properties-item_<?=$propertyN['ID']?>">
                															<span class="product-item-detail-properties-name text-muted"><?=$propertyN['NAME']?>:</span>
                															<!--<span class="product-item-detail-properties-dots"></span>-->
                															<span class="product-item-detail-properties-value"><?=(is_array($propertyN['DISPLAY_VALUE'])
													...
													<div class="app-download-form">Вы можете скачать документ резюме Скачать Application Form</div>
												</ul>
												<ul class="product-item-properties-comp-detail-info">
                            					     <div class="top-right-detail-info-comp-logo">
                            					        <?$create_user = $arResult["CREATED_BY"];
                                                        $GLOBALS['users'] = array("CREATED_BY" => $create_user); 
                                                        $userid= $create_user;
                                                        $rsUser = CUser::GetByID($userid); 
                                                        $arUserT = $rsUser->Fetch();
                                                        if ($arUserT['WORK_LOGO'] == ""){?>
                                                            <span class="none-photo_mar" border="0" alt="" width="98" height="72"><a>фото отсутствует</a></span>    
                                                        <?} else {?>
                            						...
                            						<div class="product-item-properties-comp-detail-wishes <?foreach ($favorites as $code => $disp){if ($disp == $arResult['ID']){echo "active"; $infoMessage ="Добавлено в избранное"; break; } else {echo "";}
                                                    }?>" data-type="<?=$arUserNa["UF_TYPE"];?>" <?if(!$USER->IsAuthorized()){ ?> onclick="popup_show(this);" data-popup="auth" <?}?> data-item="<?=$arResult['ID']?>"><?if ($infoMessage != ""){echo $infoMessage;} else {echo "Добавить в избранное";}?></div>
                                                    <?} else {?>
                                                        <?if ($arResult['DISPLAY_PROPERTIES']['R_R_DEVIATION']['VALUE'] != "" && $arResult['DISPLAY_PROPERTIES']['R_VERIFIED_ADMINISTRATOR']['VALUE'] == "Отклонено") {?> 
                    										    <div class="hidden-warning-not-publick-adm" style="display: block;">
                    										        <dd class="hidden-warning-not-publick-txt-war" style="margin-inline-start: 0;">Отклонено</dd>
                    										        <dd class="hidden-warning-not-publick-pre-adm" onclick="general_all_adm(this);" data-info="<?=$arResult['DISPLAY_PROPERTIES']['R_R_DEVIATION']['VALUE']?>" onclick="general_all_adm(this);" data-view="vievBe" data-type="res" data-id="<?=$arResult['ID']?>" style="margin-inline-start: 0;    padding-left: 0px;">Посмотреть причину отклонения</dd>
                    										     </div>
                    										<?} else if ($arResult['DISPLAY_PROPERTIES']['R_VERIFIED_ADMINISTRATOR']['VALUE'] == "" || $arResult['DISPLAY_PROPERTIES']['R_VERIFIED_ADMINISTRATOR']['VALUE'] == "Нет") {?>
                    										    <div class="hidden-warning-not-publick-adm"> 
                        										    <dd class="hidden-warning-not-publick-txt-adm-accept" onclick="general_all_adm(this);" data-view="accept" data-type="res" data-id="<?=$arResult['ID']?>" style="margin-inline-start: 0;">Принять</dd>
                        										    <dd class="hidden-warning-not-publick-txt-adm-del" onclick="general_all_adm(this);" data-view="del" data-type="res" data-id="<?=$arResult['ID']?>" style="margin-inline-start: 0;">Отклонить</dd>
                    										    </div>
                    										<?} else if ($arResult['DISPLAY_PROPERTIES']['R_VERIFIED_ADMINISTRATOR']['VALUE'] == "Да") {?>
                    										    <div class="hidden-warning-yeap-publick-adm"> 
                    									            <dd class="hidden-warning-not-publick-txt-adm-publick" style="margin-right: 9px;margin-inline-start: 0;">Принято</dd>
                        										    <dd class="hidden-warning-not-publick-txt-adm-del-publick" onclick="general_all_adm(this);" data-view="del" data-type="res" data-id="<?=$arResult['ID']?>"style="margin-inline-start: 0;">Отклонить</dd>
                        										</div>
                        										<?
                        										$rsUser = CUser::GetByID($arResult["CREATED_BY"]); 
                                                                $arUserSEACH = $rsUser->Fetch();
                        										?>
                        										<div class="hidden-warning-yeap-publick-adm-block">
                        										    <dd class="vac-block-user-or-comp"><input type="checkbox" class="vac-block-user-or-comp-input <? if($arUserSEACH['BLOCKED'] == "Y") {?>active" checked="checked"<?}else {?>"<?}?> id="vac-block-user-or-comp-input" data-type="blocked" data-user=<?=$arResult["CREATED_BY"]?>>Заблокировать пользователя</input></dd>
                        										</div>
                        										<script>
				...
				<div class="col">
					...
					if (!empty($arResult['DISPLAY_PROPERTIES']) || $arResult['SHOW_OFFERS_PROPS'])
					{
						...
						<div class="product-item-detail-tab-content" data-entity="tab-container" data-value="properties">
							...
							<div class="product-item-properties-comp-detail-info">
    					     <div class="top-right-detail-info-comp-logo">
    					        <?$create_user=$arResult["CREATED_BY"];
                                $GLOBALS['users'] = array("CREATED_BY" => $create_user); 
                                $userid= $create_user;
    						...
    						<div class="top-right-detail-info-comp-title"><?echo $arUserT['WORK_COMPANY']?></div>
						</div>
									<?unset($property);
									?>
								</ul>
...
<script>
    ...
    let first = document.querySelector('.product-item-detail-properties-bottom-overview');
    let editInfo = document.getElementById('page-left-top');
    let dist = second.offsetTop + first.offsetTop + first.offsetHeight + 73;
    editInfo.style.height = dist + 'px';
    let warning = false;
    
	$(document).ready(function() {
	    $('.product-item-properties-comp-detail-wishes').live('click', function() {
	        let par_resum = $('.product-item-properties-comp-detail-wishes').data("type");
	        if (par_resum == 2) {
                var favorID = $(this).attr('data-item');
                var namesClass = $(this);
                var txtClassName = '.product-item-properties-comp-detail-wishes';
