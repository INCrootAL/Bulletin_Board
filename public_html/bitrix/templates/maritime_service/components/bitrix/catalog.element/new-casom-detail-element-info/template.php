										...
										<div class="mb-3">
											...
											if (!empty($mainBlockProperties))
											{
												...
												<ul class="product-item-detail-properties">
													...
													{?>	
														<?if ($property['ID'] == 51 || $property['ID'] == 21 || $property['ID'] == 55 || $property['ID'] == 22 || $property['ID'] == 23 || $property['ID'] == 24 || $property['ID'] == 25) {?>
														<?}else if ($property['ID'] == 16){?>
															...
															<span class="product-item-detail-properties-value"><?=(is_array($property['DISPLAY_VALUE'])
																	...
																	: $property['DISPLAY_VALUE'])?><?foreach ($mainBlockProperties as $prop){if ($prop['ID'] == 51) {echo ' ' . $prop['DISPLAY_VALUE'];}}; ?>
													</span>
														</li>
														<?} else {?>
														    <li class="product-item-detail-properties-item" id="product-item-detail-properties-item_<?=$property['ID']?>">
													...
													<div class="product-item-detail-properties-bottom">
													<?php
													foreach ($mainBlockProperties as $property)
													{?>
														<?if ($property['ID'] == 16 || $property['ID'] == 17 || $property['ID'] == 52 || $property['ID'] == 18 || $property['ID'] == 19 || $property['ID'] == 51 || 
														$property['ID'] == 55 || $property['ID'] == 22 || $property['ID'] == 23 || $property['ID'] == 24 || $property['ID'] == 25 ) {?>
													...
													<div class="product-item-detail-properties-bottom-cont">
													    <?foreach ($mainBlockProperties as $property)
        													{?>
        														<?if ($property['ID'] == 16 || $property['ID'] == 17 || $property['ID'] == 52 || $property['ID'] == 18 || $property['ID'] == 19 || $property['ID'] == 51 || $property['ID'] == 21) {?>
        														<?} else if ($property['ID'] == 21){?>
        														    <li class="product-item-detail-properties-item" id="product-item-detail-properties-item_<?=$property['ID']?>">
        															<span class="product-item-detail-properties-name text-muted"><?=$property['NAME']?></span>
        															<!--<span class="product-item-detail-properties-dots"></span>-->
													...
													<?if ($USER->IsAuthorized()) { ?>
													    <?$by = $USER->GetID();
                                                        $rsUserNaN = CUser::GetByID($by);
                                                        $arUserNaN = $rsUserNaN->Fetch();
                                                        $arUserNaN["UF_TYPE"];
                                                            	...
                                                            	while ($ob = $res->GetNext()) {
                                                            		...
                                                            		if ($prop['VALUE_ENUM'] == "Да") {
                                                                        $yesParID = $NewParID;
                                                                                                                ...
                                                                                                                ?>
    													<?if ($arUserNaN["UF_TYPE"] == 1) {?>
        													<div class="product-item-detail-properties-bottom-cont-submit">
                                                                <a class="cont-submit_resume" data-pub="<?=$arResult["CREATED_BY"]?>" data-res="<?=$yesParID?>">Отправить своё резюме</a>
                                                            </div>
                                                        <?}?>
                                                    <?} else {?> 
                                                            <div class="product-item-detail-properties-bottom-cont-submit">
                                                                <a class="cont-submit_resume" onclick="popup_show(this);" data-popup="auth">Отправить своё резюме</a>
                                                            </div>
                                                    <?}?>
												...
												<ul class="product-item-properties-comp-detail-info">
                            					     <div class="top-right-detail-info-comp-logo">
                                                        ...
                                                        <?//echo "<pre>";print_r($arUserT['ID']);echo "<pre>";?>
                            						<a class="top-right-detail-info-comp-title" id="top-right-detail-info-comp-title" href="/vacancies/detailed/company/?id=<?=$arUserT['ID']?>"><?echo $arUserT['WORK_COMPANY']?></a>
                                                    <?$byNew = $USER->GetID();
                                                    ...
                                                    <?} else {?>
                                                        <?if ($arResult['DISPLAY_PROPERTIES']['R_DEVIATION']['VALUE'] != "" && $arResult['DISPLAY_PROPERTIES']['VERIFIED_ADMINISTRATOR']['VALUE'] == "Отклонено") {?> 
                										    <div class="hidden-warning-not-publick-adm" style="display: block;">
                										        ...
                										        <dd class="hidden-warning-not-publick-pre-adm" onclick="general_all_adm(this);" data-info="<?=$arResult['DISPLAY_PROPERTIES']['R_DEVIATION']['VALUE']?>" onclick="general_all_adm(this);" data-view="vievBe" data-type="vac" data-id="<?=$arResult['ID']?>" style="margin-inline-start: 0;    padding-left: 0px;">Посмотреть причину отклонения</dd>
                										     </div>
                										<?} else if ($arResult['DISPLAY_PROPERTIES']['R_DEVIATION']['VALUE'] == "" && $arResult['DISPLAY_PROPERTIES']['VERIFIED_ADMINISTRATOR']['VALUE'] == "Нет"){?>
                										    <div class="hidden-warning-not-publick-adm"> 
                    										    <dd class="hidden-warning-not-publick-txt-adm-accept" onclick="general_all_adm(this);" data-view="accept" data-type="vac" data-id="<?=$arResult['ID']?>" style="margin-inline-start: 0;">Принять</dd>
                    										    <dd class="hidden-warning-not-publick-txt-adm-del" onclick="general_all_adm(this);" data-view="del" data-type="vac" data-id="<?=$arResult['ID']?>" style="margin-inline-start: 0;">Отклонить</dd>
                										    </div>
                										<?} else if ($arResult['DISPLAY_PROPERTIES']['VERIFIED_ADMINISTRATOR']['VALUE'] == "Да") {?>
                										    <div class="hidden-warning-yeap-publick-adm"> 
                    										    ...
                    										    <dd class="hidden-warning-not-publick-txt-adm-del-publick" onclick="general_all_adm(this);" data-view="del" data-type="vac" data-id="<?=$arResult['ID']?>">Отклонить</dd>
                    										</div>
                									    <?}?>
	    ...
	    $('.product-item-properties-comp-detail-wishes').live('click', function() {
	        ...
	        if (par_resum == 1) {
	            ...
	            $('#popup_wrapper').addClass('active');
    	            ...
    	            document.getElementById("for_info_war").innerHTML = aldInnerW+"Только моряки могут добавлять вакансии в избранное"
	        }
        });
    });
    </script>
    <?if ($USER->IsAuthorized() && $arUserNaN["UF_TYPE"] == 1) { ?>
    <script>
    //Отправка резюме    
    $(document).ready(function() {
	    $('.product-item-detail-properties-bottom-cont-submit').live('click', function() {
	        let par_resum_id_user = $('.cont-submit_resume').data("pub");
	        let par_resum_id_res = $('.cont-submit_resume').data("res");
	        if (par_resum_id_user && par_resum_id_res) {
                var idUser = par_resum_id_user;
                var idResume = par_resum_id_res;
                SubmitResponses(idUser, idResume);
	        } else {
	            let popup_war = document.getElementById("popup_war");
	            popup_war.classList.add('active');
	            popup_war.style.height = "63px";
	            ...
	            $('#popup_wrapper').addClass('active');
    	            let aldInnerW = '<a class="for_info_war_svg"><svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">'+'<svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">'+'<path d="M10.5 6.75298V10.9752M10.5526 14.1419V14.2474L10.4474 14.247V14.1419H10.5526ZM1 16.6224V4.37798C1 3.19565 1 2.60404 1.2301 2.15245C1.4325 1.75522 1.75522 1.4325 2.15245 1.2301C2.60404 1 3.19565 1 4.37798 1H16.6224C17.8048 1 18.3951 1 18.8467 1.2301C19.2439 1.4325 19.5677 1.75522 19.7701 2.15245C20 2.6036 20 3.19449 20 4.37452V16.626C20 17.806 20 18.3961 19.7701 18.8472C19.5677 19.2444 19.2439 19.5677 18.8467 19.7701C18.3955 20 17.8055 20 16.6255 20H4.37452C3.19449 20 2.6036 20 2.15245 19.7701C1.75522 19.5677 1.4325 19.2444 1.2301 18.8472C1 18.3956 1 17.8048 1 16.6224Z" stroke="#A60303" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>'+'</svg></svg></a>';
    	            document.getElementById("for_info_war").innerHTML = aldInnerW+"Сожалеем, ваше резюме все еще на проверке администратора, либо еще не создано"
	        }
        });
    });
    </script>
