...
{
	?>
	<div class="data-pagination-num-main"><a class="menu-item-main" href="/vacancies/">Все вакансии</a></div>
					...
					case 1:
						...
						<div class="col-xs-12 product-item-small-card">
							<div class="row" style="display: block">
								...
								{
									?>
									<?if($item['PROPERTIES']['VERIFIED_ADMINISTRATOR']['VALUE'] == "Да") {?>
									<div class="col-xs-6 product-item-big-card">
										<div class="row">
											<div class="col-md-12">
												...
												$APPLICATION->IncludeComponent(
													'bitrix:catalog.item',
													'new-castom-catalog-item-martimer',
													array(
														'RESULT' => array(
															'ITEM' => $item,
															'AREA_ID' => $areaIds[$item['ID']],
...
let warning = false;
	$(document).ready(function() {
	    $('#properties-comp-favorites-job').live('click', function() {
	        let par_resum = $('#properties-comp-favorites-job').data("type");
	        if (par_resum == 1) {
