				...
				switch ($rowData['VARIANT'])
				{
					...
					case 1:
						...
						<div class="col-xs-12 product-item-small-card">
									...
									<div class="col-xs-6 product-item-big-card">
										...
										<div class="row">
											<div class="col-md-12">
												...
												$APPLICATION->IncludeComponent(
													'bitrix:catalog.item',
													'new-castom-catalog-item-martimer-resume-lk',
													array(
														'RESULT' => array(
															'ITEM' => $item,
															'AREA_ID' => $areaIds[$item['ID']],
							...
							if ($aq == 0) {?>
							    <div class="col-xs-6-notification" data-info="<?=$aq?>">К сожалению у вас отсутсвуте резюме, давайте это исправим!</br><a href="/">Создать резюме</a></div>
							<?}?>
