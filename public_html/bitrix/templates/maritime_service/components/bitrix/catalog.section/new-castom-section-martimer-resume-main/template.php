...
{
	?>
	<div class="data-pagination-num-main"><a class="menu-item-main" href="/resume/">Все резюме</a></div>
...
<script>
	...
	$(document).ready(function() {
	    $('#properties-comp-favorites-resume').live('click', function() {
	        let par_resum = $('#properties-comp-favorites-resume').data("type");
	        if (par_resum == 2) {
	            ...
	            if (warningG == false || warningG == true) {
	                warningG = true;
