...
<a href="javascript:void(0);" id="file-selectdialogswitcher-<?=$uid?>" class="file-selectdialog-switcher" <?
	?>onclick="BX.onCustomEvent(this.parentNode, 'BFileDLoadFormController');return false;"><div class="data-table-resume-photo-title-block">
    <span class="data-table-resume-photo-title-name" id="data-table-resume-photo-title-name">Выберите файл</span>
    <span class="fdata-table-resume-photo-title-name-lg" id="data-table-resume-photo-title-name-lg"></span>
                                </div></a>
<div id="file-selectdialog-<?=$uid?>" class="file-selectdialog" style="display:none;">
	...
	<div id="file-image-template" style='display:none;'>
		<span class="feed-add-photo-block">
			...
			<span class="feed-add-img-title" id="feed-add-img-title" data-role='name'>#name#</span>
	...
	<div class="file-extended">
		...
		<div class="file-placeholder">
			<table class="files-list" cellspacing="0">
				<tbody class="file-placeholder-tbody" id="file-placeholder-tbody">
