...
$bs_key = 1;
$linkClassName = 'main-user-consent-request-announce-bord';
if ($arResult['URL'])
{
...
<label data-bx-user-consent="<?=htmlspecialcharsbx($config)?>" class="main-user-consent-request-bord">
	<input class="input_popup_<?=$bs_key?>" id="input_popup_<?=$bs_key?>" type="checkbox" value="Y" <?=($arParams['IS_CHECKED'] ? 'checked' : '')?> name="<?=htmlspecialcharsbx($arParams['INPUT_NAME'])?>">
