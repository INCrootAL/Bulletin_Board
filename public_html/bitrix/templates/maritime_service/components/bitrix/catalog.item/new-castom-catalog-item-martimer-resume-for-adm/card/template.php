							...
							<div class="product-item-info-container product-item-hidden" data-entity="props-block">
								<dl class="product-item-properties">
									...
									{?>
										...
										<?}?>
									<?}?>
										<div style = "margin-top: 22px;" class="hidden-xs-time-publick">Дата подачи  <dd class="hidden-xs-time-publick-valu"><? echo strtolower(FormatDate("d F Y", MakeTimeStamp($pub_date)))?></dd></div>
										<?//Панель администратора?>
										<?if ($item['DISPLAY_PROPERTIES']['R_R_DEVIATION']['VALUE'] != "" && $item['DISPLAY_PROPERTIES']['R_VERIFIED_ADMINISTRATOR']['VALUE'] == "Отклонено") {?> 
										    <div class="hidden-warning-not-publick-adm"> <dd class="hidden-warning-not-publick-txt-war">Отклонено</dd><dd class="hidden-warning-not-publick-pre-adm" onclick="general_all_adm(this);" data-info="<?=$item['DISPLAY_PROPERTIES']['R_R_DEVIATION']['VALUE']?>" onclick="general_all_adm(this);" data-view="vievBe" data-type="res" data-id="<?=$item['ID']?>">Посмотреть причину отклонения</dd></div>
										<?} else if ($item['DISPLAY_PROPERTIES']['R_VERIFIED_ADMINISTRATOR']['VALUE'] == "" || $item['DISPLAY_PROPERTIES']['R_VERIFIED_ADMINISTRATOR']['VALUE'] == "Нет") {?>
										    <div class="hidden-warning-not-publick-adm"> 
    										    <dd class="hidden-warning-not-publick-txt-adm-accept" onclick="general_all_adm(this);" data-view="accept" data-type="res" data-id="<?=$item['ID']?>">Принять</dd>
    										    <dd class="hidden-warning-not-publick-txt-adm-del" onclick="general_all_adm(this);" data-view="del" data-type="res" data-id="<?=$item['ID']?>">Отклонить</dd>
										    </div>
										<?} else if ($item['DISPLAY_PROPERTIES']['R_VERIFIED_ADMINISTRATOR']['VALUE'] == "Да") {?>
										    <div class="hidden-warning-yeap-publick-adm"> 
									            <dd class="hidden-warning-not-publick-txt-adm-publick">Принято</dd>
    										    <dd class="hidden-warning-not-publick-txt-adm-del-publick" onclick="general_all_adm(this);" data-view="del" data-type="res" data-id="<?=$item['ID']?>">Отклонить</dd>
    										</div>
									    <?}?>
								</dl>
