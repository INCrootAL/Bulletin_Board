					...
					if (!$haveOffers)
					{
						if (!empty($item['DISPLAY_PROPERTIES']))
						{
							...
							<div class="product-item-info-container product-item-hidden" data-entity="props-block">
								...
								<dl class="product-item-properties-comp-favorites" id="product-item-properties-comp-favorites-job"><div data-type="<?=$arUserNa["UF_TYPE"];?>" <?if(!$USER->IsAuthorized()){ ?> onclick="popup_show(this);" data-popup="auth" <?}?> class="properties-comp-favorites <?foreach ($favorites as $code => $disp){if ($disp == $item["ID"]){echo "active";} else {echo "";}
                                }?>" id="properties-comp-favorites-job" data-item="<?echo $item["ID"]?>"></div></dl>
							</div>
							<?
						}
...
<script>
//alert(document.querySelector('.top-right-comp-title').href)
