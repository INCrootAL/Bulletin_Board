...
<?if($arResult["USE_CAPTCHA"]):?>
		<div class="field-capcha">
			...
			<div class="form-input"><input type="text" name="captcha_word" maxlength="50" class="input-field" />
			<p style="clear: left;"><input type="hidden" name="captcha_sid" value="<?echo $arResult["CAPTCHA_CODE"]?>" /><img src="/bitrix/tools/captcha.php?captcha_sid=<?echo $arResult["CAPTCHA_CODE"]?>" border-radius="10" width="204" height="55" alt="CAPTCHA" /></p>
			</div>
